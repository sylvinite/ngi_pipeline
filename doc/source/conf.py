# -*- coding: utf-8 -*-
#
# NGI Pipeline documentation build configuration file, created by
...
# sys.path.insert(0, '/Users/guillem/anaconda/envs/master/lib/python2.7/site-packages/')
...
htmlhelp_basename = 'NGIPipelinedoc'
...
man_pages = [
    ('index', 'ngipipeline', u'NGI Pipeline Documentation',
     [u'National Genomics Infrastructure Sweden'], 1)
]
...
texinfo_documents = [
  ('index', 'NGIPipeline', u'NGI Pipeline Documentation',
   u'National Genomics Infrastructure Sweden', 'NGIPipeline', 'One line description of project.',
   'Miscellaneous'),
]
