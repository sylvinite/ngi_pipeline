...
import tempfile
import os
from command_creation import build_piper_cl, build_setup_xml 
...
class TestCommandCreation(unittest.TestCase):
    ...
    def test_command_creation(self):
        ...
        assert tcl[tcl.index('--output_directory')+1]==os.path.join('$SNIC_TMP','ANALYSIS',self.p_name, 'piper_ngi')
